...
export const toolMetaList: ToolMeta[] = [
  ...
  { slug: "watermark", category: "image", dictKey: "watermark", icon: "WM", emoji: "💧", keywords: ["watermark", "stamp", "pdf", "image", "overlay", "filigran"], badge: "new", featured: true, accepts: ["png", "jpg", "webp", "pdf"], outputs: ["png", "jpg", "webp", "pdf"], nextSteps: ["image-compress", "pdf-compress"] },

...
export const toolMetaList: ToolMeta[] = [
  ...
  { slug: "pdf-watermark", category: "pdf", dictKey: "watermark", icon: "WM", emoji: "💧", keywords: ["watermark", "stamp", "pdf", "image", "overlay", "filigran"], badge: "new", featured: true, accepts: ["pdf", "png", "jpg", "webp"], outputs: ["pdf", "png", "jpg", "webp", "zip"], nextSteps: ["watermark", "pdf-compress"] },
